...
@interface JXPrivatizationManager()
...
@implementation JXPrivatizationManager
...
+ (instancetype)sharedInstance {
    ...
    static JXPrivatizationManager *instance;
    dispatch_once(&onceToken, ^{
        instance = [[JXPrivatizationManager alloc] init];
    });
    return instance;
}
...
- (void)setupPrivatizationDemo:(NSData *)data {
    ...
    if(setting) {
        [JXIMConfig sharedConfig].appKey = setting;
    }
}

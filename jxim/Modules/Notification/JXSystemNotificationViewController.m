...
#import "JXSystemNotificationViewController.h"
#import "JXSystemNotificationCell.h"
...
@interface JXSystemNotificationViewController ()<NIMSystemNotificationManagerDelegate,NIMSystemNotificationCellDelegate,NIMTeamManagerDelegate>
@property (nonatomic,strong)    NSMutableArray  *notifications;
@property (nonatomic,assign)    BOOL shouldMarkAsRead;
@end

@implementation JXSystemNotificationViewController
...
- (void)viewDidLoad {
    ...
    [self.tableView registerNib:[UINib nibWithNibName:@"JXSystemNotificationCell" bundle:nil]
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    JXSystemNotificationCell *cell = [tableView dequeueReusableCellWithIdentifier:reuseIdentifier];

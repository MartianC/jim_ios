...
#ifndef JXCustomAttachmentDefines_h
#define JXCustomAttachmentDefines_h
...
typedef NS_ENUM(NSInteger,JXCustomMessageType){
...
@protocol JXCustomAttachmentInfo <NSObject>
...
//#endif /* JXCustomAttachmentDefines_h */

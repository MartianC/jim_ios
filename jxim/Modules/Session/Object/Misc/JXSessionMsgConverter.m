...
@implementation JXSessionMsgConverter
...
+ (NIMMessage*)msgWithText:(NSString*)text
{
    ...
    textMessage.setting.apnsWithPrefix = [[JXBundleSetting sharedConfig] enableAPNsPrefix];
    textMessage.apnsMemberOption = [[NIMMessageApnsMemberOption alloc] init];
    textMessage.apnsMemberOption.forcePush = [[JXBundleSetting sharedConfig] enableTeamAPNsForce];
...
+ (NIMMessage*)msgWithImage:(UIImage*)image
{
   ...
   return [JXSessionMsgConverter generateImageMessage:imageObject];
}
...
+ (NIMMessage *)generateImageMessage:(NIMImageObject *)imageObject
{
    ...
    setting.apnsWithPrefix = [[JXBundleSetting sharedConfig] enableAPNsPrefix];
    message.apnsMemberOption = [[NIMMessageApnsMemberOption alloc] init];
    message.apnsMemberOption.forcePush = [[JXBundleSetting sharedConfig] enableTeamAPNsForce];
    return message;
}
...
+ (NIMMessage*)msgWithJenKenPon:(JXJanKenPonAttachment *)attachment
{
    ...
    message.setting.apnsWithPrefix = [[JXBundleSetting sharedConfig] enableAPNsPrefix];
    message.apnsMemberOption = [[NIMMessageApnsMemberOption alloc] init];
    message.apnsMemberOption.forcePush = [[JXBundleSetting sharedConfig] enableTeamAPNsForce];
    return message;
}

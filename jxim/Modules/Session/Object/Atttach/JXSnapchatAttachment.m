...
@interface JXSnapchatAttachment()

@property (nonatomic,assign) BOOL isFromMe;

@end

@implementation JXSnapchatAttachment
...
- (NSString *)filepath
{
    ...
    return [JXFileLocationHelper filepathForImage:filename];
}


- (NSString *)cellContent:(NIMMessage *)message{
    return @"JXSessionSnapchatContentView";
}

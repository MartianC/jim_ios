...
@implementation JXService
+ (instancetype)sharedInstance
{
    return [[JXServiceManager sharedManager] singletonByClass:[self class]];
}
...
#pragma mark - NIMServiceManager
@implementation JXServiceManager

+ (instancetype)sharedManager
{
    static JXServiceManager *instance;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        instance = [[JXServiceManager alloc]init];
    });
    return instance;
}

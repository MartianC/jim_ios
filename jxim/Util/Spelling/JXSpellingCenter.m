...
@interface JXSpellingCenter ()
- (SpellingUnit *)calcSpellingOfString: (NSString *)source;
@end


@implementation JXSpellingCenter
+ (JXSpellingCenter *)sharedCenter
{
    static JXSpellingCenter *instance = nil;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        instance = [[JXSpellingCenter alloc]init];
    });
    return instance;
}
...
- (SpellingUnit *)calcSpellingOfString:(NSString *)source
{
    ...
    for (NSInteger i = 0; i < [source length]; i++)
    {
        ...
        NSString *pinyin = [[JXPinyinConverter sharedInstance] toPinyin:word];
